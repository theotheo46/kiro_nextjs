...
react-patterns.md (inclusion: fileMatch, pattern: src/**/\*.tsx, app/**/_.tsx, components/\*\*/_.tsx)
...
api-standards.md (inclusion: fileMatch, pattern: app/api/**/\*, src/api/**/_, src/lib/api/\*\*/_)
...
testing-standards.md (inclusion: fileMatch, pattern: **/_.test._, **/_.spec._, **/**tests**/**)
...
database.md (inclusion: fileMatch, pattern: prisma/**/\*, drizzle/**/_, src/db/\*\*/_, src/lib/db/\*_/_)
...
Environment variable handling (.env.local, server-only vs public NEXT*PUBLIC*)
